...
from orbis_user_api.schemas.note import DocumentGroupCreateRequest, DocumentGroupListResponse, DocumentGroupOut
...
async def list_document_groups(
    ...
    try:
        return DocumentGroupListResponse(items=await list_document_groups_service(user, session))
