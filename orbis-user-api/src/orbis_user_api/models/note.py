...
class Note(Base):
    ...
    workspace_id: Mapped[UUID] = mapped_column(GUID(), index=True, nullable=False)
    owner_id: Mapped[UUID] = mapped_column(GUID(), index=True, nullable=False)
    notebook_id: Mapped[UUID | None] = mapped_column(GUID(), index=True)
    title: Mapped[str] = mapped_column(String(240), nullable=False)
    note_type: Mapped[str] = mapped_column(String(32), default="doc", server_default="doc", nullable=False)
    blocks: Mapped[dict[str, Any]] = mapped_column(json_type, default=dict, server_default="{}", nullable=False)
    plain_text: Mapped[str] = mapped_column(Text, default="", server_default="", nullable=False)
...
class NoteRevision(Base):
    ...
    blocks: Mapped[dict[str, Any]] = mapped_column(json_type, server_default="{}", nullable=False)
    plain_text: Mapped[str] = mapped_column(Text, default="", server_default="", nullable=False)
